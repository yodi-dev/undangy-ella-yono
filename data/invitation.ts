...
export const invitation: InvitationData = {
  seo: {
    title: 'The Wedding of Ella & Yono',
    description: 'Undangan pernikahan resmi Ella & Yono — Minggu, 11 Oktober 2026. Temukan informasi acara, lokasi, dan konfirmasi kehadiran RSVP.',
    ogTitle: 'The Wedding of Ella & Yono',
    ogDescription: 'Tanpa mengurangi rasa hormat, kami bermaksud mengundang Bapak/Ibu/Saudara/i untuk menghadiri acara pernikahan kami pada Minggu, 11 Oktober 2026.',
    ogImage: '/images/og-image.jpg',
    ogImageType: 'image/jpeg',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    ogImageAlt: 'The Wedding of Ella & Yono — Minggu, 11 Oktober 2026',
    ogUrl: 'https://undangy-ella-yono.vercel.app/',
    ogType: 'website',
    ogSiteName: 'Undangy',
    ogLocale: 'id_ID',
    twitterCard: 'summary_large_image',
    twitterTitle: 'The Wedding of Ella & Yono',
    twitterDescription: 'Tanpa mengurangi rasa hormat, kami bermaksud mengundang Bapak/Ibu/Saudara/i untuk menghadiri acara pernikahan kami pada Minggu, 11 Oktober 2026.',
